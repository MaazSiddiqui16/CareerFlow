  ...
  return (
    <div className="panel">
      <PanelTitle
        ...
        text="Applications submitted over the last 6 months."
      />
      <div className="line-chart">
        ...
        <div className="chart-area">
          <svg viewBox="0 0 600 180" preserveAspectRatio="none">
            ...
            <path
              className="area"
              d="M0 140 C80 110 100 145 160 115 S245 132 300 88 S395 30 450 62 S520 20 600 55 V180 H0 Z"
            />
          </svg>
      ...
      <small className="chart-note">
        {items.length} total applications · <span>↑ 18% vs last period</span>
      </small>
    </div>
  );
}
  ...
  return (
    <div className="panel">
      <PanelTitle
        ...
        text="Pipeline health at a glance."
      />
